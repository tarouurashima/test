...
import CashImage from '../../assets/img/moon.jpg';
...
const Home = () => {
  ...
  const tombFtmLpStats = useLpStats('TEST-FTM-LP');
  const tShareFtmLpStats = useLpStats('TSHARES-FTM-LP');
        ...
        <Grid item xs={12} sm={6}>
          <Paper style={{ backgroundColor: "transparent", boxShadow: "none", border: "1px solid var(--white)" }}>
            <Box p={4}>
              ...
              <p>
                Stake your Moon-WFTM LP in the <StyledLink href="/farms">MoonFarms</StyledLink> to earn MSHARES rewards.
                Then stake your earned MSHARES in the <StyledLink href="/">MoonRoom</StyledLink> to maximize profits!
              </p>
            </Box>
          </Paper>
				</Grid>
            ...
            <CardContent align="center">
              ...
              <Box mt={2}>
                <span style={{ fontSize: '26px' }}>
                  {tombLPStats?.tokenAmount ? tombLPStats?.tokenAmount : '-.--'} TEST /{' '}
