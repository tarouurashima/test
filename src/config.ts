...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'TEST': ['0x1a429b1Aa1a5961C7d6ac81c2FB8385c1ab3a579', 18],
      'TEST-FTM-LP': ['0x63054FF3db0EA3Da5f38a8f46b7e429cc6F41bF2', 18],
      'TSHARES': ['0xe189ba3B8BC4dDFB9B137CC080E46cF7c2634952', 18],
      'TSHARES-FTM-LP': ['0x139350BD1305816A3d18cfF86611127D8ab360E1', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  Tomb2ombWftmLPRewardPool: {
    name: 'Earn 3OMB by staking 3OMB-WFTM LP',
    poolId: 2,
    sectionInUI: 0,
  ...
  TombFtmLPTombRewardPoolOld: {
   ...
   // name: 'Earn MSHARES by Moon-WFTM LP',
   // poolId: 0,
   // sectionInUI: 2,
   // contract: 'tsharesrewardpool',
   // depositTokenName: 'TEST-FTM-LP',
   // earnTokenName: 'TSHARES',
   // finished: false,
   // multiplier: '20000x',
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn MSHARES by MSHARES-WFTM LP',
    poolId: 1,
    sectionInUI: 2,
